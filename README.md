...
# Machine Translation with LLMs Research List

**appreciate any contributions via PRs, issues**

This is a machine translation with large language models (LLMs) reading list
 ...
 * [Lost in the Source Language: How Large Language Models Evaluate the Quality of Machine Translation](https://arxiv.org/abs/2401.06568). Xu Huang, Zhirui Zhang, Xiang Geng, Yichao Du, Jiajun Chen, Shujian Huang. (arxiv 2024) {[code](https://github.com/xuuHuang/lost_in_the_src)}
...
* [Domain Terminology Integration into Machine Translation: Leveraging Large Language Models](https://arxiv.org/abs/2310.14451). Yasmin Moslem, Gianfranco Romani, Mahdi Molaei, Rejwanul Haque, John D. Kelleher, Andy Way. (WMT 2023)
